...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1200/ccs/tools/compiler/c5500_4.4.1/bin/cl55" -v5502 --memory_model=large -O2 --include_path="C:/Users/palom/Projetos/digital_table_effects/ihms/FINAL - Teste03" --include_path="C:/ti/ccs1200/ccs/tools/compiler/c5500_4.4.1/include" --define=c5502 --display_error_number --diag_warning=225 --ptrdiff_size=32 --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
