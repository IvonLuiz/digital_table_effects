...
#define N 512//2048//1024//512                              // valor usado como o tamanho dos buffers de transmissao (transmition) e recepcao (reception).
...
//DMA_Handle dmaHandleTx, dmaHandleRx;            // Declara dois handles para os canais DMA:
                                                ...
                                                // Estes handles são usados para configurar, iniciar e gerenciar os canais DMA.
...
void configAudioDma (void)
{
    ...
    dmaTxConfig.dmacssal = (DMA_AdrPtr)(((Uint32)&XmitBuffer1) << 1);           // O buffer transmition contem os dados que serao enviados.
    ...
    dmaRxConfig.dmacdsal = (DMA_AdrPtr)(((Uint32)&RcvBuffer1) << 1);             // O buffer reception, onde os dados recebidos serao armazenados.
